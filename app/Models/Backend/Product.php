...
class Product extends Model
{
    ...
    protected $fillable = ['id', 'product_keyword', 'product_menu_id', 'product_name','product_content', 'product_alias', 'product_image', 'product_price', 'product_discount', 'product_type','created_at', 'updated_at', 'product_status'];
