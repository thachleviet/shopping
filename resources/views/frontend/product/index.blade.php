                                            ...
                                            <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                                                <div class="grid-arr">
                                                    <div  class="grid-arrival">
                                                        <figure>
                                                            <a  href="{{route('san-pham.detail', $item['product_id'])}}" class="new-gri" >
                                                                {{----}}
                                                                <div class="grid-img">
                                                    ...
                                                    @endif
                                                    <div class="women">
                                                        <h6><a href="{{route('san-pham.detail', $item['product_id'])}}">{{$item['product_name']}}</a></h6>
                                                        ...
                                                        <a href="{{route('san-pham.detail',$item['product_id'])}}"  data-text="Xem chi tiết" class="my-cart-b item_add">Xem chi tiết</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
