        ...
        <div class="page-title-inner flex-row  medium-flex-wrap container">
            <div class="flex-col flex-grow medium-text-center">
                <div class="is-large">
                    ...
                    <nav class="woocommerce-breadcrumb breadcrumbs"><a href="{{route('home')}}">Trang chủ</a> <span class="divider">/</span>Tìm kiếm</nav></div>
            ...
            <div class="flex-col medium-text-center">
                <p class="woocommerce-result-count hide-for-medium">
                    @if(!empty($_objectProduct))
                    Hiển thị từ {{($_objectProduct->firstItem()) ? $_objectProduct->firstItem() : 0}} đến {{($_objectProduct->lastItem()) ? $_objectProduct->lastItem() : 0}} của  {{($_objectProduct->total()) ?$_objectProduct->total():0}} sản phẩm</p>
                    @endif
            </div>
