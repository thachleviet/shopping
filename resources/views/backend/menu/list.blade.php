            ...
            @foreach($_object as $key=>$item)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href='javascript:void(0)' class="btn btn-xs btn-warning" onclick="Menu.changeStatus(this, '{{$item['id']}}', '{{($item["menu_status"] == 1) ? "active" :"un-active"}}')"><i class="{{($item["menu_status"] == 1) ? "fa fa-lock" :"fa fa-unlock-alt"}}"></i> Khóa</a>
