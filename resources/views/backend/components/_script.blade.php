...
{{----}}
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('static/backend')}}/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Slimscroll -->
<script src="{{asset('static/backend')}}/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
...
<script src="{{asset('static/js/laroute.js')}}"></script>
