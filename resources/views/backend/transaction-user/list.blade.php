                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if (empty($item['transaction_status']))
                            <a href='javascript:void(0)' onclick="Transaction.confirmOrder(this, '{{$item['transaction_id']}}')"><span class="label label-warning"> Chưa xác nhận </span></a><br>
                            <a href="{{route('transaction-user.detail-order-user',$item['transaction_id'])}}">Xem chi tiết</a>
                        @else
