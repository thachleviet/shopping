    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-group row">
                    <div class="col-md-12" style="color: red; font-size: 22px; font-weight: bold"> <img class="col-md-3" src="{{public_path('images/logo_nhu.PNG')}}" width="150" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HÓA ĐƠN THANH TOÁN GIAO HÀNG</div>
            </div>
            <div class="box">
                ...
                <div class="box-body">
                    <form method="get" action="{{route('transaction-user.generate-order-fill',$objectTransaction['transaction_id'])}}">
                        ...
                        <div class="table-responsive">
                            ...
                            <div style="width: 100%;margin-top: 30px ; ">
                                ...
                                <div class="bill-right" >
                                    ...
                                    <strong >Thuế VAT : </strong> <label class="col-md-5 text-right">5% </label><br>
                                    <strong >Tổng tiền thanh toán  : </strong> <label class="col-md-5 text-right">{{number_format((int)$total + (int)$total*(5/100),2) }} vnđ</label>
                                </div>
                            </div>
                            <div class="clear"></div>
                            <div style="width: 100%; margin-top: 50px ; ">
                                <div class="bill bill-info" >
                                    ...
                                    <label class="info">Họ tên : </label> {{$objectTransaction['name']}}<br>
                                    <label class="info">Số điện thoại: </label> {{$objectTransaction['phone']}}<br>
                                    <label class="info">Email : </label> {{$objectTransaction['email']}}<br>
                                    <label class="info">Số nhà  : </label> {{($objectTransaction['address']) ?$objectTransaction['address_customer']: $objectTransaction['address'] }}<br>
