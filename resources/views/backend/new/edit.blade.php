...
@section('content')
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <form id="form_add_product" role="form" method="post" action="{{route('new.update', $_object['id'])}}" enctype="multipart/form-data">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-9 col-md-offset-2 form-group  {{($errors->has('new_type')) ? 'has-error': ''}}" >
                                            ...
                                            <select  class=" form-control" name="new_type" id="new_type">
                                                <option value="new" {{($_object['new_type'] == 'new') ? 'selected' : ''}}> Tin tức</option>
                                                <option value="guide" {{($_object['new_type'] == 'guide') ? 'selected' : ''}}> Hướng dẫn</option>
                                            </select>
                                        ...
                                        <div class="col-md-9 col-md-offset-2 form-group  {{($errors->has('new_title')) ? 'has-error': ''}}" >
                                            <label >Tiêu đề</label>
                                            <input type="text" class="form-control" name="new_title" value="{{$_object['new_title']}}" placeholder="Tiêu đề">
                                        ...
                                        <div class="col-md-9 col-md-offset-2 form-group "  >
                                            <label >Mô tả</label>
                                            <textarea style="height: 200px" class=" form-control" name="new_description" id="new" placeholder="Nhập mô tả">{{$_object['new_description']}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row" >
                                        <div class="col-md-9 col-md-offset-2 form-group {{($errors->has('new_content')) ? 'has-error': ''}}">
                                            <label>Nội dung
                                            </label>
                                            <div >
                                                <textarea style="min-height: 400px;"  class="form-control new_content" id="new_content" name="new_content" placeholder="Nội dung bài viết">{{$_object['new_content']}}</textarea>
