    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-7 col-lg-offset-2">
                <form role="form" method="post" action="{{route('slide.update', $_object['id'])}}" enctype="multipart/form-data">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$_object['slider_name']}}" type="text" class="form-control" name="slider_name" placeholder="Tên slide ">
                            </div>
                            <div class="form-group {{($errors->has('slider_title')) ? 'has-error': ''}}" >
                                <label >Tiêu đề</label>
                                <input value="{{$_object['slider_title']}}" type="text" class="form-control" name="slider_title" placeholder="Tiêu đề">
                            ...
                            <div class="form-group {{($errors->has('slider_image')) ? 'has-error': ''}}" >
                                ...
                                @if($_object['slider_image'])
                                    <img src="{{asset($_object['slider_image'])}}" width="200" height="200">
                                @endif
                            ...
                            <div class="form-group {{($errors->has('slider_type')) ? 'has-error': ''}}" >
                                ...
                                <select  class="form-control select2" name="slider_type">
                                    <option value="slide" {{($_object['slider_type'] == 'slide') ? 'selected' : ''}}>Slide</option>
                                    <option value="logo" {{($_object['slider_type'] == 'logo') ? 'selected' : ''}}>Logo</option>
                                    <option value="qc" {{($_object['slider_type'] == 'qc') ? 'selected' : ''}}>Quảng Cáo</option>
                                </select>
                            ...
                            <div class="form-group {{($errors->has('menu_status')) ? 'has-error': ''}}" >
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="slider_status" {{($_object['slider_status'] == 1) ? 'checked' : ''}} checked value="1">
                                <span >Hoạt động</span>

                                <input type="radio"  name="slider_status" {{($_object['slider_status'] == 0) ? 'checked' : ''}} value="0">
