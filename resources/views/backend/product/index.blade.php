            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <a href='javascript:void(0)' onclick="Product.removeMulti()" class=" btn btn-warning"> <i class="fa fa-remove"></i> Xóa </a>
                        <a href="{{route('product.add')}}" class=" btn btn-primary"> <i class="fa fa-plus"></i> Thêm </a>
                    </div>
                    <div class="box-body">
